...
#Hourly
rrdtool graph /var/www/html/hourly_incoming_packets.png --start -3600 -a PNG --lower-limit 0 \
-t "Hourly Incoming packets" --vertical-label "Total number of incoming packets" -w 700 -h 300 \
DEF:packets_i1=/var/lib/rrdtool/packets.rrd:packets_i1:LAST LINE2:packets_i1#ff0000:"lo" \
DEF:packets_i2=/var/lib/rrdtool/packets.rrd:packets_i2:LAST LINE2:packets_i2#55ff00:"ens160" \
DEF:packets_i3=/var/lib/rrdtool/packets.rrd:packets_i3:LAST LINE2:packets_i3#0059ff:"ens192" \
DEF:packets_i4=/var/lib/rrdtool/packets.rrd:packets_i4:LAST LINE2:packets_i4#ffe100:"ens224"
#Daily
rrdtool graph /var/www/html/daily_incoming_packets.png --start -1d -a PNG --lower-limit 0 \
-t "Daily Incoming packets" --vertical-label "Total number of incoming packets" -w 700 -h 300 \
DEF:packets_i1=/var/lib/rrdtool/packets.rrd:packets_i1:LAST LINE2:packets_i1#ff0000:"lo" \
DEF:packets_i2=/var/lib/rrdtool/packets.rrd:packets_i2:LAST LINE2:packets_i2#55ff00:"ens160" \
DEF:packets_i3=/var/lib/rrdtool/packets.rrd:packets_i3:LAST LINE2:packets_i3#0059ff:"ens192" \
DEF:packets_i4=/var/lib/rrdtool/packets.rrd:packets_i4:LAST LINE2:packets_i4#ffe100:"ens224"
#Weekly
rrdtool graph /var/www/html/weekly_incoming_packets.png --start -1w -a PNG --lower-limit 0 \
-t "Weekly Incoming packets" --vertical-label "Total number of incoming packets" -w 700 -h 300 \
DEF:packets_i1=/var/lib/rrdtool/packets.rrd:packets_i1:LAST LINE2:packets_i1#ff0000:"lo" \
DEF:packets_i2=/var/lib/rrdtool/packets.rrd:packets_i2:LAST LINE2:packets_i2#55ff00:"ens160" \
DEF:packets_i3=/var/lib/rrdtool/packets.rrd:packets_i3:LAST LINE2:packets_i3#0059ff:"ens192" \
DEF:packets_i4=/var/lib/rrdtool/packets.rrd:packets_i4:LAST LINE2:packets_i4#ffe100:"ens224"
